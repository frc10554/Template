...
object TunerConstants {
    ...
    private val steerGains = Slot0Configs()
        .withKP(85.0).withKI(0.0).withKD(0.24)
        .withKS(0.08).withKV(2.33).withKA(0.0)
    ...
    private val kSteerFeedbackType = SteerFeedbackType.FusedCANcoder

    // The stator current at which the wheels start to slip;
    // This needs to be tuned to your individual robot
    private val kSlipCurrent: Current = Amps.of(58.0)
    ...
    val kCANBus = CANBus("*", "./logs/drivetrain.hoot")

    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    val kSpeedAt12Volts: LinearVelocity = MetersPerSecond.of(5.6)
    ...
    private val kWheelRadius: Distance = Inches.of(1.9025)
    ...
    // Front Left
    private const val kFrontLeftDriveMotorId = 9
    private const val kFrontLeftSteerMotorId = 2
    private const val kFrontLeftEncoderId = 1
    private val kFrontLeftEncoderOffset: Angle = Rotations.of(0.374267578125)
    private const val kFrontLeftSteerMotorInverted = true
    private const val kFrontLeftEncoderInverted = false

    private val kFrontLeftXPos: Distance = Inches.of(10.875)
    private val kFrontLeftYPos: Distance = Inches.of(10.875)
    ...
    private val kFrontRightEncoderOffset: Angle = Rotations.of(0.14990234375)
    private const val kFrontRightSteerMotorInverted = true
    private const val kFrontRightEncoderInverted = false

    private val kFrontRightXPos: Distance = Inches.of(10.875)
    private val kFrontRightYPos: Distance = Inches.of(-10.875)

    // Back Left
    private const val kBackLeftDriveMotorId = 7
    private const val kBackLeftSteerMotorId = 8
    private const val kBackLeftEncoderId = 4
    private val kBackLeftEncoderOffset: Angle = Rotations.of(0.322265625)
    private const val kBackLeftSteerMotorInverted = true
    private const val kBackLeftEncoderInverted = false

    private val kBackLeftXPos: Distance = Inches.of(-10.875)
    private val kBackLeftYPos: Distance = Inches.of(10.875)

    // Back Right
    private const val kBackRightDriveMotorId = 5
    private const val kBackRightSteerMotorId = 6
    private const val kBackRightEncoderId = 3
    private val kBackRightEncoderOffset: Angle = Rotations.of(-0.19921875)
    private const val kBackRightSteerMotorInverted = true
    private const val kBackRightEncoderInverted = false

    private val kBackRightXPos: Distance = Inches.of(-10.875)
    private val kBackRightYPos: Distance = Inches.of(-10.875)
    ...
    class TunerSwerveDrivetrain : SwerveDrivetrain<TalonFX, TalonFX, CANcoder> {
        ...
        constructor(
            ...
            DeviceConstructor { deviceId: Int, canbus: CANBus? -> TalonFX(deviceId, canbus) },
            DeviceConstructor { deviceId: Int, canbus: CANBus? -> TalonFX(deviceId, canbus) },
            DeviceConstructor { deviceId: Int, canbus: CANBus? -> CANcoder(deviceId, canbus) },
            drivetrainConstants,
            *modules
        )
